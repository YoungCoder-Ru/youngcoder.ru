...
На видео показан процесс установки IDE Pelles C Version 8.00. На данный момент актуальная версия 13.01. Процесс установки незначительно отличается.

1. Сайт [https://pellesc.de](https://forum.pellesc.de/index.php) теперь ведёт на форум программы. Скачивать установщик нужно по [ссылке](https://www.pellesc.se/).
...
Инструкция по установке Pelles C v.13.01.
