...
- Попробуйте скомпилировать программу из Листинга 5. Какую ошибку выдаёт ваш компилятор? Напишите её в комментариях к этому уроку с указанием названия и версии компилятора.
