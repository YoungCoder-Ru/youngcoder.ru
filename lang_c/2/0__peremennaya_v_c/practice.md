...
- Раз вы уже изучаете программирование, то в будущем хотите написать какую-то крутую и полезную программу: систему управления для робота, компьютерную игру или ещё какой-то проект. Попробуйте найти в нём или его части модель "чёрного ящика"? Какие данные поступают на вход? Какие данные на выходе?