...
- Теперь вы можете увидеть, как выглядит мусор, который хранится в переменной после её объявления. Для этого объявите переменную любого типа и выведете её значение на экран используя функцию `printf`
...
- Выясните, почему escape-последовательность `?` можно выводить без обратного слэша.
