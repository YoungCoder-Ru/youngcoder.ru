...
Модификатор ширины поля или просто модификатор ширины позволяет задать минимальнуе ширину поля (минимальное количество позиций), которое будет зарезервировано для вывода значения.
