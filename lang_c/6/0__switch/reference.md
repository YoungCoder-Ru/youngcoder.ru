...
Такой способ представления более нагляден. Например, по этому рисунку можно сразу понять, что при поступлении команды `p`, если состояние было `1`, то принтер останется в состоянии `1`, а при поступлении команд `e` или `r` произойдёт переход в состояние `0`.
