...
![Рис. 2 Результат работы программы Листинг 2](./char_code_symbol.png "Рис. 3 Результат работы программы Листинг 2")
...
![](./char_arithmetic.png "Рис. 4 Результат работы программы Листинг 3.")
...
```
![Результат работы программы из Листинга 4 на различных входных данных](./char_in_if.png "Рис. 5 Результат работы программы из Листинга 4 на двух различных входных данных")
...
![](./char_volume.png "Рис. 6 Результат работы программы для проверки диапазона типа char (char -- знаковый)")

Но некоторые компиляторы и даже ваш компилятор при определённых настройках может выдать другой результат.
![](./char_volume2.png "Рис. 7 Результат работы программы для проверки диапазона типа char (с особыми настройками компилятора, char -- беззнаковый)")
