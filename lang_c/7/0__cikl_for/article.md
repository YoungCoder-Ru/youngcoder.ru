...
> Если рассматривать отношение этих чисел к общему количеству генераций, получим `49/100` и `51/100` или `53/100` и `47/100`. Но чем больше экспериментов мы проведём, тем эти значения будут ближе к `1/2`.
